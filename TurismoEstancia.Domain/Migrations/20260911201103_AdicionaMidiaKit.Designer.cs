...
namespace TurismoEstancia.Domain.Migrations
{
    ...
    [Migration("20260911201103_AdicionaMidiaKit")]
    partial class AdicionaMidiaKit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurismoEstancia.Domain.Models.ConhecaEstanciaItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Categoria", "Ordem");

                    b.ToTable("ConhecaEstanciaItens");
                });
            ...
            modelBuilder.Entity("TurismoEstancia.Domain.Models.MidiaKitItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TurismoEstancia.Domain.Models.Noticia", b =>
                {
                    ...
                    b.Property<int?>("GaleriaCategoriaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TurismoEstancia.Domain.Models.PontoTuristico", b =>
                {
                    ...
                    b.Property<int>("LeftPercentMobile")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int>("TopPercentMobile")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("TurismoEstancia.Domain.Models.Noticia", b =>
                {
                    b.HasOne("TurismoEstancia.Domain.Models.GaleriaCategoria", "Galeria")
                        .WithMany()
                        .HasForeignKey("GaleriaCategoriaId")
                        .OnDelete(DeleteBehavior.SetNull);
